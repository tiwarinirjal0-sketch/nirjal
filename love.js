...
yes.addEventListener("click", (e) =>{
    ...
    message.textContent = "Wow Congratulations! you guys are a match now"
    ...
    messageStyle2.left = "40%"
    messageStyle2.top = "50%"
    messageStyle2.color = "white"
